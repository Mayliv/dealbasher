...
const kazDeals: Deal[] = [
  {
    ...
    region: "kz",
    isKaspiRed: true,
    kaspiInstallment: { months: 24, monthlyPayment: 16625 },
    kaspiScore: 4.8,
  },
  {
    id: 102,
  ...
  },
  {
    ...
    marketplace: "mechta",
    region: "kz",
    kaspiInstallment: { months: 12, monthlyPayment: 12492 },
    kaspiScore: 4.5,
  },
  {
    id: 105,
    title: "Samsung Galaxy S24 Ultra 256GB",
    description: "Kaspi RED рассрочка 0-0-24 без переплаты",
    originalPrice: 689990,
    dealPrice: 599990,
    discount: 13,
    store: "Kaspi Shop",
    category: "electronics",
    imageUrl: "https://placehold.co/400x300/cc0000/fff?text=Galaxy+S24+RED",
    postedBy: "kz_tech",
    ...
    region: "kz",
    isKaspiRed: true,
    kaspiInstallment: { months: 24, monthlyPayment: 25000 },
    kaspiScore: 4.9,
  },
  {
    id: 106,
    title: "Dyson Airwrap Complete",
    description: "Kaspi RED 0-0-12 + кэшбэк бонусами",
    originalPrice: 329990,
    dealPrice: 289990,
    discount: 12,
    store: "Kaspi Shop",
    category: "beauty",
    imageUrl: "https://placehold.co/400x300/cc0000/fff?text=Dyson+RED",
    postedBy: "beauty_kz",
    ...
    region: "kz",
    isKaspiRed: true,
    kaspiInstallment: { months: 12, monthlyPayment: 24166 },
    kaspiScore: 4.7,
  },
];
